...
/** Route ids (see data/routes.ts) a fact geographically belongs to. */
export type KnowledgeDay = 'donnerstag' | 'freitag' | 'samstag' | 'sonntag' | 'alternative';

export interface KnowledgeFact {
  id: string;
  category: KnowledgeCategory;
  /** Tour days this fact is relevant to (by route id). */
  days: KnowledgeDay[];
  title: string;
  text: string;
